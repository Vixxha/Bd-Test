...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full">
      {/* Announcement Bar */}
      <div className="bg-primary text-white text-center py-2.5 px-4 text-xs font-semibold tracking-wide border-b border-primary/10 shadow-xs">
        Envío gratis a toda la R.M. por compras sobre $50.000
      </div>
      <nav className="bg-white border-b border-soft transition-all duration-300">
            ...
            <div className="flex items-center">
              <Link href="/" className="flex items-center space-x-2">
                ...
                <span className="font-serif text-2xl font-bold text-dark tracking-tight">
                  Chile <span className="text-primary">Frutos Secos</span>
                </span>
              </Link>
            </div>
