      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="font-serif text-2xl font-bold tracking-tight text-white">
                Nut<span className="text-accent">Store</span>
              </span>
            </Link>
            <p className="text-white/60 text-sm leading-relaxed">
              Selección premium de frutos secos, semillas y productos envasados de origen 100% natural, directo a tu mesa.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li className="text-white/60">Lunes a Viernes: 09:00 - 18:00</li>
              <li className="text-white/60">Contacto: contacto@nutstore.cl</li>
              <li className="text-white/60">Teléfono: +56 9 1234 5678</li>
              <li className="text-white/60">Santiago, Chile</li>
            </ul>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center text-xs text-white/40 space-y-4 sm:space-y-0">
          <div>&copy; {new Date().getFullYear()} NutStore. Todos los derechos reservados.</div>
